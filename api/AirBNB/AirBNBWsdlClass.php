<?php
/**
 * File for AirBNBWsdlClass to communicate with SOAP service
 * @package AirBNB
 ...
 */
/**
 * AirBNBWsdlClass to communicate with SOAP service
 * 
 * @package AirBNB
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20140325-01
 * @date 2014-09-24
 */
class AirBNBWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'http://my-api.us/airbnb.com/server.php?wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses AirBNBWsdlClass::setLastError()
     * @uses AirBNBWsdlClass::initSoapClient()
     * @uses AirBNBWsdlClass::initInternArrayToIterate()
     * @uses AirBNBWsdlClass::_set()
    ...
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'AirBNBWsdlClass'))
            {
     ...
     * @uses AirBNBClassMap::classMap()
     * @uses AirBNBWsdlClass::getDefaultWsdlOptions()
     * @uses AirBNBWsdlClass::getSoapClientClassName()
     * @uses AirBNBWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('AirBNBClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = AirBNBClassMap::classMap();
     ...
     * If a class is named as {AirBNB}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('AirBNBSoapClient') && is_subclass_of('AirBNBSoapClient','SoapClient'))
            return 'AirBNBSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses AirBNBWsdlClass::WSDL_CACHE_WSDL
     * @uses AirBNBWsdlClass::WSDL_COMPRESSION
     * @uses AirBNBWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses AirBNBWsdlClass::WSDL_ENCODING
     * @uses AirBNBWsdlClass::WSDL_EXCEPTIONS
     * @uses AirBNBWsdlClass::WSDL_FEATURES
     * @uses AirBNBWsdlClass::WSDL_LOGIN
     * @uses AirBNBWsdlClass::WSDL_PASSWORD
     * @uses AirBNBWsdlClass::WSDL_SOAP_VERSION
     * @uses AirBNBWsdlClass::WSDL_STREAM_CONTEXT
     * @uses AirBNBWsdlClass::WSDL_TRACE
     * @uses AirBNBWsdlClass::WSDL_TYPEMAP
     * @uses AirBNBWsdlClass::WSDL_URL
     * @uses AirBNBWsdlClass::VALUE_WSDL_URL
     * @uses AirBNBWsdlClass::WSDL_USER_AGENT
     * @uses AirBNBWsdlClass::WSDL_PROXY_HOST
     * @uses AirBNBWsdlClass::WSDL_PROXY_PORT
     * @uses AirBNBWsdlClass::WSDL_PROXY_LOGIN
     * @uses AirBNBWsdlClass::WSDL_PROXY_PASSWORD
     * @uses AirBNBWsdlClass::WSDL_LOCAL_CERT
     * @uses AirBNBWsdlClass::WSDL_PASSPHRASE
     * @uses AirBNBWsdlClass::WSDL_AUTHENTICATION
     * @uses AirBNBWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses AirBNBWsdlClass::getSoapClient()
     * @uses AirBNBWsdlClass::getFormatedXml()
     ...
     * @uses AirBNBWsdlClass::getSoapClient()
     * @uses AirBNBWsdlClass::convertStringHeadersToArray()
     ...
     * @uses AirBNBWsdlClass::getInternArrayToIterate()
     * @uses AirBNBWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses AirBNBWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses AirBNBWsdlClass::getInternArrayToIterateOffset()
     * @uses AirBNBWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses AirBNBWsdlClass::getInternArrayToIterateOffset()
     * @uses AirBNBWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @uses AirBNBWsdlClass::getAttributeName()
     * @uses AirBNBWsdlClass::__toString()
     * @uses AirBNBWsdlClass::_set()
     * @uses AirBNBWsdlClass::_get()
     * @uses AirBNBWsdlClass::setInternArrayToIterate()
     * @uses AirBNBWsdlClass::setInternArrayToIterateIsArray()
     * @uses AirBNBWsdlClass::setInternArrayToIterateOffset()
